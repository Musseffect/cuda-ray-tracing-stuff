...
class  SceneGrammarParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleNumber = 0, RuleScene = 1, RuleExpression = 2, RuleFunctionArguments = 3
  };

  SceneGrammarParser(antlr4::TokenStream *input);
  ~SceneGrammarParser();
  ...
  public:
    ...
    SceneGrammarParser::NumberContext *value = nullptr;
    NumberContext *number();
    virtual void enterRule(antlr4::tree::ParseTreeListener *listener) override;
    virtual void exitRule(antlr4::tree::ParseTreeListener *listener) override;
